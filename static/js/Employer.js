...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const jobs = [
      ...
      },
      {
        ...
        description: 'Join our design team to create beautiful, intuitive user interfaces for our clients. Work closely with developers to implement your designs.',
      ...
      },
      {
        ...
        description: 'We\'re seeking a data scientist to help us analyze complex datasets and extract meaningful insights for our clients.',
      ...
      },
      {
        ...
        description: 'Looking for a DevOps engineer to help us optimize our cloud infrastructure and streamline deployment processes.',
      ...
      },
      {
        ...
        description: 'Join our backend team to build scalable APIs and services for our growing product suite.',
      ...
      },
      {
        ...
        description: 'We\'re looking for a product manager to help us define and execute our product roadmap.',
    ...
    const applications = [
      {
        ...
        matchScore: 92,
        resumeUrl: '#',
        coverLetter: 'I am very interested in the Senior Frontend Developer position at TechCorp Solutions. With over 5 years of experience in React and TypeScript, I believe I would be a valuable addition to your team.'
      },
      {
        id: 2,
        candidateId: 5,
        ...
        matchScore: 87,
        resumeUrl: '#',
        coverLetter: 'I would like to apply for the Senior Frontend Developer position. I have worked with React for 3 years and have a strong passion for creating performant user interfaces.'
      },
      {
        id: 3,
        candidateId: 1,
        ...
        matchScore: 78,
        resumeUrl: '#',
        coverLetter: 'I am applying for the UX/UI Designer position. I have 4 years of experience designing interfaces for web and mobile applications.'
      },
      {
        id: 4,
        candidateId: 4,
        ...
        matchScore: 95,
        resumeUrl: '#',
        coverLetter: 'I am excited to apply for the Data Scientist position. With my background in statistical analysis and machine learning, I am confident I can deliver valuable insights for your clients.'
      },
      {
        id: 5,
        candidateId: 2,
        ...
        matchScore: 65,
        resumeUrl: '#',
        coverLetter: 'I am interested in the Backend Developer position. I have worked with Java and Spring Boot for 2 years and am eager to join your team.'
      }
    ];
    ...
    const candidates = [
      {
        ...
        skills: ['UI Design', 'User Research', 'Figma', 'Adobe XD', 'Sketch'],
        matchScore: 78
      },
      {
        id: 2,
        ...
        skills: ['Java', 'Spring Boot', 'MySQL', 'NoSQL', 'RESTful APIs'],
        matchScore: 65
      },
      {
        id: 3,
        ...
        skills: ['JavaScript', 'React', 'TypeScript', 'Redux', 'HTML/CSS'],
        matchScore: 92
      },
      {
        id: 4,
      ...
      },
      {
        ...
        skills: ['JavaScript', 'React', 'CSS3', 'HTML5', 'Responsive Design'],
        matchScore: 87
      },
      {
        id: 6,
    ...
    const interviews = [
      {
        ...
        time: '10:00',
        type: 'video',
        notes: 'Focus on React experience and system design questions.'
      },
      {
        id: 2,
        applicationId: 3,
        ...
        time: '14:30',
        type: 'in-person',
        notes: 'Ask to review portfolio and discuss design process.'
      },
      {
        id: 3,
        applicationId: 4,
        ...
        time: '11:15',
        type: 'video',
        notes: 'Technical discussion about machine learning algorithms and case study.'
      }
    ];
